                            ...
                            <div className="grid grid-cols-3 gap-8">
                                <div className="flex flex-col items-center space-y-2 border-gray-800 p-4 rounded-lg">
                                    ...
                                    <p className="text-zinc-200 dark:text-zinc-100">
                                        Aeternity&lsquo;s enchanting platform:
                                        effortlessly forge, deploy, and
                                        transform your ideas into powerful smart
                                        contracts.
                                    </p>
                                </div>
                                <div className="flex flex-col items-center space-y-2 border-gray-800 p-4 rounded-lg">
                                    ...
                                    <p className="text-zinc-200 dark:text-zinc-100">
                                        Create smart contracts effortlessly with
                                        Aeternity. Intuitive interface, Sophia
                                        language, and LLM guidance for
                                        excellence.
                                    </p>
                                </div>
                                <div className="flex flex-col items-center space-y-2 border-gray-800 p-4 rounded-lg">
