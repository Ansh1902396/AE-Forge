...
const sophiaTokens: SophiaTokens = {
  identifier: <p>Represents an identifier starting with a lowercase letter.</p>,
  constructor: <p>Represents a constructor starting with an uppercase letter.</p>,
  qualifiedIdentifier: (
  ...
  integerLiteral: (
    <p>Represents an integer literal with optional underscore separators.</p>
  ),
  byteArrayLiteral: (
    <p>Represents a byte array literal with optional underscore separators.</p>
  ),
  stringLiteral: <p>Represents a string literal enclosed in double quotes.</p>,
  charLiteral: <p>Represents a character literal enclosed in single quotes.</p>,
  accountAddress: (
    <p>Represents a base58-encoded 32-byte account pubkey with ak_ prefix.</p>
  ),
  contractAddress: (
    <p>Represents a base58-encoded 32-byte contract address with ct_ prefix.</p>
  ),
  oracleAddress: (
    <p>Represents a base58-encoded 32-byte oracle address with ok_ prefix.</p>
  ),
  oracleQueryId: (
    <p>Represents a base58-encoded 32-byte oracle query id with oq_ prefix.</p>
  ),
